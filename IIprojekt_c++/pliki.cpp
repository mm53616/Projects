...
const char MAX = 50;
const int MAX_LICZBA = 100; // bo nie jest dynamiczna
...
osoba tablica_osob[MAX_LICZBA]; // mozna jeszcze z *tablica_osob dynamiczna
...
para tablica_par[MAX_LICZBA]; // mozna jeszcze z *tablica_par dynamiczna
...
//tabela_osob = new osoba[liczba_osob];
//tabela_par  = new para[liczba_par];
